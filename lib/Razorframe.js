...
const rz = {
  ...
  init(http, config) {
    ...
    if (!sticky.listen(http, config.port)) {
      // Master code
      // io.adapter(redisAdapter(`redis://rediscloud:2dfnKjdph4GyDuO3@redis-19519.c11.us-east-1-2.ec2.cloud.redislabs.com:19519`));
      io.adapter(redisAdapter(`redis://razorframe-redis-001.gut7bb.0001.usw2.cache.amazonaws.com`));
